        ...
        methods: {
            ...
            graphchart(){
                this.graphChartOption.series[0].data=[
                    ...
                    {"id":"11","name":(this.popHotsRanking)[2],"itemStyle":null,"symbolSize":26.66666666666667,"x":-87.93029,"y":-6.8120565,"attributes":{"modularity_class":1},"value":100,"label":{"normal":{"show":true}},"category":1},
                    ...
                    {"id":"20","name":(this.popHotsRanking)[3],"itemStyle":null,"symbolSize":23.638097333333334,"x":-408.12122,"y":-464.5048,"attributes":{"modularity_class":2},"value":20.457146,"label":{"normal":{"show":true}},"category":5},
