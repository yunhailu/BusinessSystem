<template>
   ...
   <!--     <div class="charts">
            <div class="chart timeBar" :click="clickChartAction" v-echarts="sentimentBarOption" :loading="sentimentBarLoading" ></div>&lt;!&ndash;theme="infographic"&ndash;&gt;
            &lt;!&ndash;<div class="chart percentBar" v-echarts="sentimentChartOption" :loading="sentimentChartLoading" ></div>&ndash;&gt;
            <div class="chart percentBar" v-echarts="sentimentPieOption" :loading="sentimentPieLoading"></div>
        </div>
        &lt;!&ndash;<div class="charts"></div>&ndash;&gt;
-->
